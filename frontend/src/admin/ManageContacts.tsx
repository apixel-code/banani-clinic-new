    ...
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        <p className="text-gray-500 text-sm">
          {contacts.length} submissions total
        </p>
        {unread > 0 && (
          <span
                    ...
                    <tr key={c.id} className="hover:bg-gray-50">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs font-medium ${!c.read ? "text-gray-900" : "text-gray-600"}`}
                          >
                            {c.name}
                          </span>
                        </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <a
                    ...
                    className="text-sm font-semibold flex items-center gap-1.5 hover:text-blue-600 transition-colors"
                    style={{ color: "#1A3A5C" }}
                  >
                    <Phone size={14} />
                    {selected.phone}
              ...
              <span
                ...
                style={{
                  backgroundColor: selected.read ? "#dcfce7" : "#fef9c3",
                  color: selected.read ? "#166534" : "#854d0e",
                }}
              >
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
              ...
              <button
                onClick={() => setSelected(null)}
                className="flex-1 py-2.5 text-sm rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors"
              >
                Close
              </button>
            </div>
