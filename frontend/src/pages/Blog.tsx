...
export default function Blog() {
  ...
  return (
    <>
      <Helmet>
        <title>
          {buildTitle("Dental Health Blog – Tips & Treatment Guides")}
        </title>
        <meta
          name="description"
          content="Expert dental health tips, treatment guides, and patient stories from Dr. Aslam Al Mehdi and the Banani Clinic team."
        />
      </Helmet>
      <div ref={ref}>
        <section
        ...
        >
          <div className="container-custom text-center">
            ...
            <p
              ...
              style={{ color: "#bfdbfe" }}
            >
              Expert articles, treatment guides, and patient stories from Dr.
              Aslam Al Mehdi.
            </p>
          </div>
        </section>
