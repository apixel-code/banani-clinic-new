        ...
        if (data) {
          api
            ...
            .then((all) => {
              const related = (all || [])
                .filter(
                  (p: any) => p.category === data.category && p.slug !== slug,
                )
                .slice(0, 3);
              setRelated(related || []);
            })
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 pt-20">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4" style={{ color: "#1A3A5C" }}>
            Post Not Found
          </h1>
          ...
          {post.og_image && (
            <div className="relative h-64 md:h-80 lg:h-96">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, rgba(26,58,92,0.8), transparent)",
                }}
              />
            </div>
          )}
          ...
          <div className="container-custom">
            ...
            <div className="grid lg:grid-cols-3 gap-8 md:gap-10">
              <article className="lg:col-span-2">
                <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-blue-100 fade-in">
                  <span
                    className="badge mb-4 text-white"
            ...
            {related.length > 0 && (
              <div className="mt-12 md:mt-16">
                <h2
                  className="text-xl md:text-2xl font-bold mb-6 fade-in"
                  style={{ color: "#1A3A5C" }}
                >
                  Related Articles
                </h2>
